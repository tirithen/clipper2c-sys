...
pub type ClipperZCallback64 = ::std::option::Option<
    unsafe extern "C" fn(
...
>;
pub type ClipperZCallbackD = ::std::option::Option<
    unsafe extern "C" fn(
        user_data: *mut ::std::os::raw::c_void,
        e1bot: *const ClipperPointD,
        e1top: *const ClipperPointD,
        e2bot: *const ClipperPointD,
        e2top: *const ClipperPointD,
        pt: *mut ClipperPointD,
    ),
>;
...
extern "C" {
    pub fn clipper_clipper64_set_z_callback(
        c: *mut ClipperClipper64,
        user_data: *mut ::std::os::raw::c_void,
        cb: ClipperZCallback64,
    );
}
extern "C" {
...
extern "C" {
    pub fn clipper_clipperd_set_z_callback(
        c: *mut ClipperClipperD,
        user_data: *mut ::std::os::raw::c_void,
        cb: ClipperZCallbackD,
    );
}
extern "C" {
