...
fn main() {
    build(cfg!(feature = "usingz"));

    #[cfg(feature = "generate-bindings")]
    {
        generate_bindings("bindings", false);
        generate_bindings("bindings_usingz", true);
    }
}

fn build(usingz: bool) {
...
#[cfg(feature = "generate-bindings")]
fn generate_bindings(bindings_name: &str, usingz: bool) {
    ...
    let out_bindings = out_path.join(bindings_name.to_string() + ".rs");
